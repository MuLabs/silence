	...
	public function getFormatedMessage()
	{
		switch ($this->code) {
			...
			case self::SERVICE_REGISTRATION_ERROR:
				...
				break;
			case self::CONTEXT_TYPE_NOT_FOUND:
			...
			case self::HANDLER_CLOSURE_ERROR:
				...
				break;
			case self::HANDLER_NAME_ALREADY_REGISTERED:
				return 'Handler name is already registered -- ' . $this->message;
				break;
		}
