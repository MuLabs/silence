                ...
                if ($res) {
                    ...
                    if (!in_array($res['name'], $tagsNotClosed)) {
                        ...
                        if ($res['close']) {
                            // HTML validation
                            if (count($parents) < 1) {
                                throw new HTML2PDF_exception(3, $res['name'], $this->getHtmlErrorCode(
                                    $res['html_pos']
                                ));
                            } else {
                                if ($parents[count($parents) - 1] != $res['name']) {
                                    throw new HTML2PDF_exception(4, $parents, $this->getHtmlErrorCode(
                                        $res['html_pos']
                                    ));
                                } else {
